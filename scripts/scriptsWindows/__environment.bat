...
REM *************************
REM loader stuff e.g. CHANGE THE content of the loader.xml
REM *************************
SET LOADER=%LIB%\someLoader.jar%LIB%\someOtherLoader.jar
...
REM SET ARG1=../models/cube.wrl
REM SET ARG1=../models/apina.wrl
SET ARG1=../models/sphere.wrl
SET ARG2=0
SET ARG3=%WTK_APPS%\Demoni\res\test.m3g
SET ARG4=../models/background.jpg
SET ARG5=../res/loader.xml
